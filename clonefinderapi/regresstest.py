...
significant_seq0=open('C:\\Users\\tuf78332\\Desktop\\CloneFinderAPI\\clonefinderapi\\Test_bino.meg','r').readlines()
significant_seq=[]
for i in significant_seq0:
    significant_seq.append(i.strip())
CloFre='C:\\Users\\tuf78332\\Desktop\\CloneFinderAPI\\clonefinderapi\\test_bino.txt'
print significant_seq
CloFreCom = CloneFrequencyComputer(significant_seq, tsp_list, 0.01)
Tu2Clo,Name2Col,T2C2F=GetCloHitForTu(CloFre ,0)

final_seq, final_clone_frequency = CloFreCom.regress_hit_clone(T2C2F)
Align.save_mega_alignment_to_file('Test_final.meg', final_seq)
CloFreAna.save_frequency_table_to_file('test_final.txt', final_clone_frequency,  [])	
