...
class SNPGroupCombiner_cnv():
    ...
    def __init__(self, cluster_information, original_seq, tumor_seq, tsp_list, clone_frequency_cutoff, optionOnOff, CluNumCutOff, CNV_info, option_b):
        ...
        if NewNameOrder!=[]:
          ...
          #  print Seq			
            ...
            if self.TrunkAnc=='On': 
              ...
              #  print Ori[1:], TuIdentical_seq.count(Ori[1:])               
         ...
         # print  NewCloLs      
          ...
          if Added=='y' :
               ...
               clone_frequency = CloneFrequencyComputer_cnv(new_seq, alt_frequency, self.CNV_info, self.option_b, self.freq_cutoff)
